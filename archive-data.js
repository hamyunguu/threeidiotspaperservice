/* Archive production notes shared by the archive dialog and the AI Worker.
   These are visual estimates from the finished objects, not production records.
   Exact stock, weight, and hidden construction must be confirmed with a printer. */

...
표시합니다. 펄럭임은 표면 변형 애니메이션과 감쇠 진동으로 구현했으며 실제 용지
물성 시뮬레이션은 아닙니다. 상품 전환 시 캔버스 높이가 바뀌므로
